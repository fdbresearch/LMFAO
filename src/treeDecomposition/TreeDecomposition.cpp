...
void TreeDecomposition::computeVariableOrder()
{
    // First get all join attributes - This is given by join attribute mask in db

    // Then go over root - and add the join attributes to the order
    // continue with left to right depth first traversal

    // once a variable is added we set a flag in another bitset

    // **********

    // When all join attributes are added -- we again go over the tree and add
    // all remaining attributes



    
    // TODO: how do we represent the order? -- Vector of attributeIDs

    // TODO: we want to create two orders: joinKeyOrder & completeAttributeOrder
}


void TreeDecomposition::buildFromFile() 
{
    // TODO: update RelationToNodeMapping 
}
