...
#define LMFAO_LOG_DBG(...)
#define LMFAO_LOG_INFO(...)
#define LMFAO_LOG_BENCH(...)
...
#undef LMFAO_LOG_INFO
#define LMFAO_LOG_INFO(...) LMFAO_LOG_INTERNAL(INFO, __VA_ARGS__)
#endif

#if LMFAO_LOG_LEVEL < 3
#undef LMFAO_LOG_BENCH
#define LMFAO_LOG_BENCH(...) LMFAO_LOG_BENCH_INTERNAL(__VA_ARGS__)
#endif

#if LMFAO_LOG_LEVEL < 4
#undef LMFAO_LOG_WARNING
#define LMFAO_LOG_WARNING(...) LMFAO_LOG_INTERNAL(WARNING, __VA_ARGS__)
#endif

#if LMFAO_LOG_LEVEL < 5
#undef LMFAO_LOG_ERROR
#define LMFAO_LOG_ERROR(...) LMFAO_LOG_INTERNAL(ERRROR, __VA_ARGS__)
#endif
