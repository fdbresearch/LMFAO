...
namespace LMFAO::LinearAlgebra
{
    ...
    void SVDecompEigDec::getSingularValues(Eigen::VectorXd& vSingularValues) const
    {
        vSingularValues.resize(mvSingularValues.size());
        for (uint32_t idx = 0; idx < mvSingularValues.size(); idx ++)
        {
