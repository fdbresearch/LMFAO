...
class PrecisionWorkbook:
    ...
    def __init__(self, output_path, precision):
    ...
    def save(self):
        self.work_book.save(self.output_path)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-op", "--output_path", dest="output_path", required=True)
